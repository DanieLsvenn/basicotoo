...
export const API_ENDPOINTS = {
  ...
  ACCOUNT: {
    ...
    ACTIVATE_USER: (id: string) => `${API_BASES.ACCOUNT}/api/Account/active-user/${id}`,
  },
  ...
  LAWYER: {
    ...
    BY_SERVICE: (serviceId: string) => `${API_BASES.ACCOUNT}/api/Lawyer/service/${serviceId}`,
  },
  ...
  STAFF: {
    ...
    PAGINATED: (page: number, pageSize: number) => `${API_BASES.ACCOUNT}/api/Staff?page=${page}&pageSize=${pageSize}`,
    ACTIVE_PAGINATED: (page: number, pageSize: number) => `${API_BASES.ACCOUNT}/api/Staff/Active?page=${page}&pageSize=${pageSize}`,
  },
  ...
  SHIFTS: {
    ...
    DAY_OFF_BY_ID: (dayOffId: string) => `${API_BASES.ACCOUNT}/api/day-off/${dayOffId}`,
    DAY_OFF_QUERY: (fromDate: string, toDate: string) => 
      `${API_BASES.ACCOUNT}/api/day-off?fromDate=${fromDate}&toDate=${toDate}`,
    JUSTIFY_DAY_OFF: (dayOffId: string) => `${API_BASES.ACCOUNT}/api/day-off/justify/${dayOffId}`,
  },

  // Booking endpoints
  BOOKING: {
    BASE: `${API_BASES.BOOKING}/api/Booking`,
    BY_ID: (bookingId: string) => `${API_BASES.BOOKING}/api/Booking/${bookingId}`,
    ...
    CHECK_IN: (bookingId: string) => `${API_BASES.BOOKING}/api/Booking/check-in/${bookingId}`,
    CHECK_OUT: (bookingId: string) => `${API_BASES.BOOKING}/api/Booking/check-out/${bookingId}`,
  },
  ...
  FEEDBACK: {
    ...
    BY_ID: (feedbackId: string) => `${API_BASES.BOOKING}/api/feedback/${feedbackId}`,
    BY_BOOKING: (bookingId: string) => `${API_BASES.BOOKING}/api/feedback/booking/${bookingId}`,
  },
  ...
  TICKET: {
    ...
    REPLY: (ticketId: string) => `${API_BASES.TICKET}/api/Ticket/${ticketId}/reply`,
    PACKAGES_ACTIVE: `${API_BASES.TICKET}/api/ticket-packages-active`,
    PACKAGE: `${API_BASES.TICKET}/api/ticket-package`,
    PACKAGE_BY_ID: (packageId: string) => `${API_BASES.TICKET}/api/ticket-package/${packageId}`,
  },
  ...
  FORM: {
    ...
    BY_CUSTOMER: (customerId: string) => `${API_BASES.FORM}/api/form/customer/${customerId}`,
    CUSTOMER_FORM: (customerFormId: string) => `${API_BASES.FORM}/api/customer-form/${customerFormId}`,
  },
  ...
  // External APIs
  EXTERNAL: {
    CURRENCY_CONVERT: (apiKey: string, from: string, to: string, amount: number) => 
